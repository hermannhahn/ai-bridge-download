...
## 📥 Download da Última Versão: `v2.0.11`
...
- 📦 **Instalador Executável Direto**: [Baixar AI-Bridge-Setup-v2.0.11.exe](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.0.11.exe)
...
1. Baixe o instalador [`AI-Bridge-Setup-v2.0.11.exe`](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.0.11.exe).
