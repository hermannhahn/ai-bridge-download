...
## 📥 Download da Última Versão: `v2.2.4`
...
- 📦 **Instalador Executável Direto**: [Baixar AI-Bridge-Setup-v2.2.4.exe](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.2.4.exe)
...
1. Baixe o instalador [`AI-Bridge-Setup-v2.2.4.exe`](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.2.4.exe).
