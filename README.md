...
## 📥 Download da Última Versão: `v2.3.143`
...
- 📦 **Instalador Executável Direto**: [Baixar AI-Bridge-Setup-v2.3.143.exe](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.3.143.exe)
...
1. Baixe o instalador [`AI-Bridge-Setup-v2.3.143.exe`](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.3.143.exe).
