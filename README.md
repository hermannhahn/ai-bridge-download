...
## 📥 Download da Última Versão: `v2.1.5`
...
- 📦 **Instalador Executável Direto**: [Baixar AI-Bridge-Setup-v2.1.5.exe](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.1.5.exe)
...
1. Baixe o instalador [`AI-Bridge-Setup-v2.1.5.exe`](https://github.com/hermannhahn/ai-bridge-download/raw/main/AI-Bridge-Setup-v2.1.5.exe).
